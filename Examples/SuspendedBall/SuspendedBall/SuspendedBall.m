...
#define MineBundle [NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"SuspendedBall" ofType:@"bundle"]]
...
+ (instancetype)sharedInstance {
    ...
    dispatch_once(&onceToken, ^{
        ...
        sharedInstance.berthImage = [UIImage sd_animatedGIFWithData:[NSData dataWithContentsOfFile:[MineBundle pathForResource:@"redpacket" ofType:@"gif"]]];
        sharedInstance.draggingImage = [UIImage sd_animatedGIFWithData:[NSData dataWithContentsOfFile:[MineBundle pathForResource:@"girl" ofType:@"gif"]]];
